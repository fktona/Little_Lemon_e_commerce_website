    ...
    <button onClick={() => Navigate(-1)}
      ...
      <div>
       <h3 className="text-2xl font-semibold mb-4 text-primary">Call Us</h3>
        ...
        <p className="mb-4 text-secondary">
          08123235678</p></div>
          <div>
        <h3 className="text-2xl font-semibold mb-4 text-primary">Company Address</h3>
      ...
      <div className="md:w-1/2 px-4 mt-8 md:mt-0">
        ...
        <form className="space-y-4">
          <div>
            <label htmlFor="name" className="block font-medium mb-1 text-secondary">
              Name
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="email" className="block font-medium mb-1 text-secondary">
              Email
            </label>
            <input
              type="email"
          ...
          <div>
            <label htmlFor="message" className="block font-medium mb-1 text-secondary">
              Message
            </label>
            <textarea
              id="message"
